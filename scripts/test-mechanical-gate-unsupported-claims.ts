...
const cases: [string, number][] = [
  ...
  ['控除率100%の適用をお約束します。', 1],
  ['当社は控除率100%という実績を誇ります。', 1],
  ['控除率100%という満足度です。', 1],
  ['控除率100%の適用をご提供します。', 1],
  ['控除率100%という圧倒的な効果です。', 1],
  ['控除率100%の区分ですから当社にお任せください。', 1],
  ['当社がお約束する控除率100%。', 1],
  ['控除率100%、これをお約束します。', 1],
  ['税率100%と定められています。', 0],
  ['控除率100%の適用要件を確認します。', 0],
  ['控除率100%という記載を確認します。', 0],
  ['控除率100%の区分です。別件のお約束を確認します。', 0],
  ['控除率100%の区分です。満足度100%という実績を誇ります。', 1],
];
